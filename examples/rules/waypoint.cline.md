<!--
  Waypoint rules for Cline (VS Code).
  Copy this file to:  .clinerules/waypoint.md  in the repo you want tracked
  (or paste the body into a single-file .clinerules at the repo root).
