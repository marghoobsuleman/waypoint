<!--
  Waypoint rules for GitHub Copilot (VS Code / JetBrains agent mode).
  Copy this file to:  .github/copilot-instructions.md  in the repo you want tracked.
  Copilot uses MCP servers configured in your editor — add Waypoint there first
  (see examples/mcp-config.md).
-->
...
- Use the `resume_project` tool (no arguments — it auto-detects the project from the
...
- Use `add_worklog_entry` to record meaningful progress, decisions
