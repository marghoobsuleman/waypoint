<!--
  Waypoint rules for Google Antigravity.
  Antigravity follows the AGENTS.md open standard — copy this file to:  AGENTS.md
  at the ROOT of the repo you want tracked. If your Antigravity version manages rules
  in-app (Workspace rules / Knowledge), paste the "## Waypoint" section there instead.
