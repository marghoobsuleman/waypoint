<!--
  Waypoint rules for Windsurf.
  Copy this file to:  .windsurf/rules/waypoint.md  in the repo you want tracked
  (or paste the body into a legacy .windsurfrules file at the repo root).
  In the Windsurf rule UI, set the activation mode to "Always On".
