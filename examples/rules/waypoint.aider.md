<!--
  Waypoint conventions for Aider.
  Copy this file to:  CONVENTIONS.md  at the repo root, then have Aider always read it:
    aider --read CONVENTIONS.md
  …or add to .aider.conf.yml:
    read: CONVENTIONS.md
  Aider talks to MCP servers via its config — see examples/mcp-config.md.
-->
